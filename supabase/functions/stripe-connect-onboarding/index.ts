...
serve(async (req) => {
  ...
  try {
    ...
    // This would normally be: https://connect.stripe.com/setup/...
    const mockOnboardingUrl = `https://connect.stripe.com/setup/e/acct_mock_${Date.now()}`;
    
    logStep("Stripe Connect onboarding URL generated", { url: mockOnboardingUrl });

    return new Response(JSON.stringify({ 
      url: mockOnboardingUrl,
      message: "Stripe Connect onboarding URL generated successfully"
    }), {
